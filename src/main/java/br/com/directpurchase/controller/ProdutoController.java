...
public class ProdutoController {
	...
	@PostMapping(path = "/produto/salvar", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Object> salvar(@ModelAttribute ProdutoDto request)
			throws APIException {
		try {
